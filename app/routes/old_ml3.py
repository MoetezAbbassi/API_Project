...
Endpoints:
- POST /api/ml/identify-equipment: Identify equipment and get suggested exercises
- GET /api/ml/predictions/<user_id>: List user's ML predictions
- POST /api/ml/add-exercise-to-workout: Add selected exercise to workout
"""
...
# Equipment to muscle groups mapping
EQUIPMENT_TO_MUSCLES = {
    ...
    "Smith Machine": ["chest", "back", "legs", "shoulders"],
    "Leg Press": ["legs"],
    "Pull-up Bar": ["back", "arms"],
    "Rowing Machine": ["back", "cardio", "arms"],
}
...
def get_exercises_for_equipment(equipment_name: str) -> list:
    """
    Get exercises that can be done with identified equipment with full details
    
    Args:
        equipment_name: Name of identified equipment
        
    Returns:
        List of exercise objects with muscle groups and difficulty
    """
    # Get muscle groups for this equipment
    muscles = EQUIPMENT_TO_MUSCLES.get(equipment_name, ["cardio"])
...
def identify_equipment(token_user_id):
    ...
    try:
        ...
        # Get suggested exercises with full details
